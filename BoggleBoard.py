#Word Boggle .Find words in the Board
...
# A word is constructed in the boggle board by connecting adjacent (horizontally, vertically, or diagonally) letters, without using any single letter at a given position more than once;
# while a word can of course have repeated letters, those repeated letters must come from different positions in the boggle board in order for the word to be contained in the board.
# Note that two or more words are allowed to overlap and use the same letters in the boggle board.
# board = [
# ["t", "h", "i", "s", "i", "s", "a"], ["s", "i", "m", "p", "l", "e", "x"],
# ["b", "x", "x", "x", "x", "e", "b"],
# ["x", "o", "g", "g", "l", "x", "o"],
# ["x", "x", "x", "D", "T", "r", "a"],
# ["R", "E", "P", "E", "A", "d", "x"],
...
# Sample Output
# ["this", "is", "a", "simple", "boggle", "board", "NOTRE-PEATED"] // The words could be ordered differently.
...
def explore(i,j,board,trieNode,visited,finalWords):
    ...
    for m,n in neighbors:
        explore(m,n,board,trieNode,visited,finalWords)
    visited[i][j]=False
